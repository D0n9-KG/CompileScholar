...
Input : .research_tmp/runs/kernel_v2/A2G_EVO2_PPR_866D169A4642/concept_graph.json
...
CG = os.path.abspath(os.path.join(BASE, "runs", "kernel_v2", "A2G_EVO2_PPR_866D169A4642", "concept_graph.json"))
